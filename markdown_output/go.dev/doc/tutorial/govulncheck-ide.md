...
3.  [Tutorial: Find and fix vulnerable dependencies with VS Code Go](/doc/tutorial/govulncheck-ide)
...
![Run Toggle Vulncheck](editor_tutorial_1.png)
...
![govulncheck code action](editor_tutorial_2.png)

![VS Code Go govulncheck output](editor_tutorial_3.png)
...
![Hover over dependency for vulnerability information](editor_tutorial_4.png)
...
![Upgrade to Latest via code action menu](editor_tutorial_5.png)
