...
# Content structure Stay organized with collections Save and categorize content based on your preferences.
...
| [`<section>`](https://developer.mozilla.org/docs/Web/HTML/Element/section) 1 | [region](https://developer.mozilla.org/docs/Web/Accessibility/ARIA/Roles/region_role) |1 Requires inclusion of the `name` attribute to be accessible. A `section` must be [accessibly-named](https://www.w3.org/WAI/ARIA/apg/practices/names-and-descriptions/#whatareaccessiblenamesanddescriptions?) for its implicit ARIA role of [`region`](https://developer.mozilla.org/docs/Web/Accessibility/ARIA/Roles/region_role) to be visible to assistive technology.
...
**Note:** Check out the [ARIA Landmarks Example](https://www.w3.org/WAI/ARIA/apg/patterns/landmarks/examples/main.html) for more information and best practices.
...
**Note:** While you can use [ARIA heading roles](https://developer.mozilla.org/docs/Web/Accessibility/ARIA/Roles/heading_role) for heading levels, it's recommended you use semantic HTML heading levels whenever possible.
...
arrow\_back ARIA and HTML](/learn/accessibility/aria-html)

[

Next

The Document arrow\_forward](/learn/accessibility/more-html)
