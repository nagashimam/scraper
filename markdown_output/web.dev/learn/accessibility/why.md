...
# What is digital accessibility, and why does it matter? Stay organized with collections Save and categorize content based on your preferences.
...
![Six people representing various disabilities. Each character is represented.](/static/learn/accessibility/why/image/six-representing-various-cf6d14f05378.png)
...
**Tip:** To learn more about identity and language choices, we recommend reading [Demystifying Disability: What to Know, What to Say, and How to be an Ally](https://emilyladau.com/book/) by Emily Ladau.

### Visual impairments

![A woman using a white cane.](/static/learn/accessibility/why/image/a-woman-using-white-cane-db3e64d7a0dee.png)
...
*   _Prevalence_: 253 million people have visual impairment worldwide. 36 million are blind, 217 million have moderate to severe visual impairment (MSVI), according to [Community eye health volume 30](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5820628/), and 1 in 12 men and 1 in 200 women are colorblind, according to [Colour Blind Awareness](https://www.colourblindawareness.org/colour-blindness/).
*   _Tools_: Screen reader software, screen magnification tools, Braille output devices.
*   _Pain points_: Digital products that don't work with screen reader software, mobile websites and apps without pinch to zoom, complex graphs and charts differentiated by colors alone, color contrasts that make it difficult to read text on the screen.
...
![A man in a wheelchair, holding an open laptop.](/static/learn/accessibility/why/image/a-man-a-wheelchair-hold-43235f662a94c.png)
...
*   _Prevalence_: [1 in 7 people have mobility issues](https://www.cdc.gov/media/releases/2018/p0816-disability.html#:%7E:text=One%20in%204%20U.S.%20adults,affects%201%20in%207%20adults).
*   _Tools_: Adaptive switches, eye tracking devices, mouth and head sticks, and speech input.
...
![A man with a hearing aid.](/static/learn/accessibility/why/image/a-man-a-hearing-aid-e1862049f8bab.png)
...
*   _Tools_: hearing aids, captions, transcripts, and sign language.
*   _Pain points_: Audio content without text transcript and video without synchronized captions.
...
![An older woman in glasses, holding an animal.](/static/learn/accessibility/why/image/an-older-woman-glasses-139f64808d3b.png)
...
*   _Prevalence_: Varies by condition.
*   _Tools_: Screen readers, text highlighting, text prediction, abstractive summarization tools.
...
Read a short [New York Times article](https://www.nytimes.com/2022/08/30/opinion/face-blindness-prosopagnosia.html) or [watch a video](https://youtu.be/3-MzNPcEh6M) on prosopagnosia, also known as face blindness.
...
![A person in a green jacket with glasses.](/static/learn/accessibility/why/image/a-person-a-green-jacket-36b7cd6eeac71.png)
...
*   _Prevalence_: 50 million people worldwide have epilepsy, according to the [World Health Organization (WHO)](https://www.who.int/health-topics/epilepsy). 1.8 million adults worldwide have bilateral vestibular hypofunction (BVH), according to [Johns Hopkins Medicine](https://www.hopkinsmedicine.org/news/newsroom/news-releases/implant-improves-balance-movement-and-quality-of-life-for-people-with-inner-ear-disorder).
*   _Tools_: Operating system settings to reduce motion. In Windows, this setting is framed positively as **Show animation**, and is turned off. On Android, the setting **Remove animations** is turned on.
...
![A person wearing glasses and waving.](/static/learn/accessibility/why/image/a-person-wearing-glasses-d2b2800585ea5.png)

A [speech disorder](https://www.pennmedicine.org/for-patients-and-visitors/patient-information/conditions-treated-a-to-z/speech-and-language-disorders#:%7E:text=A%20speech%20disorder%20is%20a,Articulation%20disorders) is a condition in which a person has problems creating or forming the speech sounds needed to communicate with others.

*   _Examples_: Muscular or cognitive issues that impede speech, such as apraxia, dysarthria, or stuttering.
*   _Prevalence_: 18.5 million individuals have a speech, voice, or language disorder, according to the [National Institute on Deafness and Other Communication Disorders (NIDCD)](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language)
*   _Tools_: Augmentative and alternative communication (AAC) and speech-generating devices.
...
Read a short [New York Times article](https://www.nytimes.com/2022/08/23/opinion/stutter-speech-listening.html) or [watch a video](https://youtu.be/m0E_wMIwfSI) on stuttering and technology.

### Additional beneficiaries of accessibility

![Three people representing temporary and situational disabilities, such as
a pregnant woman and a person on crutches.](/static/learn/accessibility/why/image/other-disabilities.png)
...
*   _Search engine optimization (SEO) bots_. SEO bots do not have senses like sight and hearing and navigate by keyboard only. Your websites are crawled more effectively when your site is accessible.
...
![A collection of coins to represent the lost revenue when disabled communities are ignored.](/static/learn/accessibility/why/image/a-collection-coins-repr-20ba4acb05d85.png)
...
Beyond the individual and business impact, you should also be aware of the looming [legal impact](https://f.hubspotusercontent30.net/hubfs/3280432/Remediated-2021-Year-End-Report-FINAL.pdf) of building inaccessible digital products. Public sector entities in the United States, such as government-funded programs and schools, airlines, and nonprofits, must follow certain digital accessibility rules, while many private sector companies don't. In countries such as Canada, the United Kingdom, Japan, Australia, and the European Union, stricter [digital accessibility laws](https://www.w3.org/WAI/policies/) exist for both public and private companies.

For many disabled people in the United States, filing a lawsuit is their only option to bring awareness and change to digital products. It's estimated that, in the US, over ten lawsuits are filed daily focused on digital accessibility. Many businesses have received multiple digital accessibility-based lawsuits. And every year, the number of total lawsuits has increased.
