...
# Welcome to Learn AI! Stay organized with collections Save and categorize content based on your preferences.

In this course, we help you build a foundation of knowledge about artificial intelligence (AI), to add features to your websites and web applications. You've likely already used AI in some capacity, such as prompting in [Gemini](https://gemini.google.com/) or ChatGPT's interface, reading generated summaries in Google Search, or vibe coding with tools like [Antigravity](https://antigravity.google/). Here, you learn decision frameworks to design and integrate AI into your applications.

If you're familiar with the web.dev Learn courses, such as [HTML](/learn/html), [Accessibility](/learn/accessibility), and [Privacy](/learn/privacy), this may look a little different. We know that engineering roles are changing and will continue to change. While reading and writing code is still a critical part of a web developer's job, your most important role with AI is planning your system.
...
**Tip:** You may encounter unfamiliar terms in these modules. We recommend you consult the course [glossary](/learn/ai/glossary) and the [machine learning glossary](https://developers.google.com/machine-learning/glossary).
...
### [Generative AI](/learn/ai/generative)

Understand if you need a generative AI model for your web application.

### [Build responsibly with AI](/learn/ai/responsibility)
...
### [Pick your platform](/learn/ai/platform)

Your choice impacts the speed, cost, scalability, and trustworthiness of your AI system.

### [Choose a client-side library](/learn/ai/client-side)
...
### [Evaluation-driven development](/learn/ai/evaluation-driven-development)
