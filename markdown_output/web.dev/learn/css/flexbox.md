...
# Flexbox Stay organized with collections Save and categorize content based on your preferences.
...
![Three boxes next to each other with an arrow, pointing left to right. The arrow is labelled Main axis](/static/learn/css/flexbox/image/three-boxes-next-each-w-7b5d0fbdaf522.svg)
...
![Three boxes of different heights, next to each other with an arrow, pointing left to right. The arrow is labelled Main axis. There's another arrow pointing top to bottom. This one is labelled Cross axis](/static/learn/css/flexbox/image/three-boxes-different-he-20fd54d77efbb.svg)
...
*   [Content reordering](/articles/content-reordering)
...
![A labelled diagram of the above terms](/static/learn/css/flexbox/image/a-labelled-diagram-the-a-a9bf061b5d5b2.svg)
...
box of the container.](/static/learn/css/flexbox/image/a-flex-container-nine-it-e0d8b646b8c9c.jpg)
...
**Note:** There is also a value of `flex: none`, which will give you inflexible flex items that do not grow or shrink. This might be useful if you are purely using flexbox to access the alignment properties but don't want any flexible behavior.
...
**Note:** For the `justify-content` property to do anything you have to have spare space in your container on the main axis. If your items fill the axis then there is no space to share out so the property won't do anything.
...
arrow\_back Layout](/learn/css/layout)

[

Next

Grid arrow\_forward](/learn/css/grid)
