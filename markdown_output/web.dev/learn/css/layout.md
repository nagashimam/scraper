...
![A timeline showing how CSS has evolved over the years, starting in 1996 up to 2021](/static/learn/css/layout/image/a-timeline-showing-css-h-b4ed206a35185.svg)
...
![A diagram showing all the different sizes of a box and where each sizing section starts and ends](/static/learn/css/layout/image/a-diagram-showing-the-di-4e46d3ae32e54.png)
...
**Note:** We will be going into much more detail for both of these in future modules, but here is a high-level overview of what both are and what they are useful for.
...
**Warning:** When you use `float`, keep in mind that any elements following the floated element may have their layout adjusted. To prevent this, you can clear the float, either by using `clear: both` on an element that follows your floated element _or_ with `display: flow-root` on the parent of your floated elements. Find out more in the article [The end of the clearfix hack](https://rachelandrew.co.uk/archives/2017/01/24/the-end-of-the-clearfix-hack/).
...
arrow\_back Sizing Units](/learn/css/sizing)

[

Next

Flexbox arrow\_forward](/learn/css/flexbox)
