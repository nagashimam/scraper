...
[Source](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/list-style-position)
...
![A list with both outside and inside ::marker which shows that outside (default value) is not in the list-item and is inside the list-item content box.](/static/learn/css/lists/image/a-list-both-outside-ins-cc3285c12d7cc.jpg)
...
**Note:** This property is a bit limited in controlling the position and size of the bullets, so we recommend using the [`::marker`](#marker_pseudo-element) property for a more customizable approach.
...
![A list with three items which shows that each of the bullets are ::marker pseudo-elements.](/static/learn/css/lists/image/a-list-three-items-show-bcda4715c5de5.jpg)
...
**Note:** Note: `::marker` elements precede any pseudo-elements that you may have inserted using CSS `::before`.

### Marker styles

Now that you have selected the marker, let's look at the styling properties available to this selector. You can learn more about [Custom bullets with CSS ::marker](/articles/css-marker-pseudo-element) on web.dev.
...
**Note:** In ordered lists, the bullets default to numbers. The `::marker` content value is a use case for [counters](https://developer.mozilla.org/docs/Web/CSS/CSS_Lists_and_Counters/Using_CSS_counters) to create custom numbering.
...
*   [Custom bullets with CSS ::marker](/articles/css-marker-pseudo-element)
...
arrow\_back Blend Modes](/learn/css/blend-modes)

[

Next

Counters arrow\_forward](/learn/css/counters)
