...
# Spacing Stay organized with collections Save and categorize content based on your preferences.
...
![Three stacked boxes with a downward arrow](/static/learn/css/spacing/image/three-stacked-boxes-a-do-9c3f96bcb965c.svg)
...
![A diagram of the four main areas of the box model.](/static/learn/css/spacing/image/a-diagram-the-four-main-0547c6c8ed138.svg)
...
A box with arrows showing the directions too.](/static/learn/css/spacing/image/the-word-trouble-runnin-645c6ed02703c.svg)
...
**Note:** In the previous module on [logical properties](/learn/css/logical-properties), you learned that instead of specifying `margin-top`, `margin-right`, `margin-bottom` and `margin-left`, you can use `margin-block-start`, `margin-inline-end`, `margin-block-end` and `margin-inline-start`.
...
![A box with arrows pointing inwards to show that padding lives inside a box](/static/learn/css/spacing/image/a-box-arrows-pointing-in-2872ab772a788.png)
...
![A diagram representation of a grid with gaps](/static/learn/css/spacing/image/a-diagram-representation-5f42dbf13f58c.svg)
...
using either 20px for a layout or 1em for flow content.](/static/learn/css/spacing/image/consistent-spacing-betwee-eb88766a9292e.svg)
...
arrow\_back Custom Properties](/learn/css/custom-properties)

[

Next

Pseudo-elements arrow\_forward](/learn/css/pseudo-elements)
