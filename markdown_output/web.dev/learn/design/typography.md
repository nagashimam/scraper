...
**Note:** You may even need to consider the primary language of your user, as you may need to leave room for accents and other special characters. Learn more about this in the [internationalization](/learn/design/internationalization) module.
...
Don't set your line-lengths with a fixed unit like `px`. Users can scale their font size up and down and your line lengths should adjust accordingly. Use a [relative unit](/learn/css/sizing#relative_lengths) like `rem` or `ch`.
...
**Note:** You can mitigate the jarring effect of text shifting around by using [`size-adjust`](/articles/css-size-adjust) in your `@font-face` rule.
...
**Note:** If you're styling elements using the `system-ui` value for `font-face` property, you might get all the benefits of variable fonts without downloading any font files. [More and more system fonts are now variable fonts](/blog/more-variable-font-options-in-chromium-83).
...
Fonts don't have display types.
...
arrow\_back Micro layouts](/learn/design/micro-layouts)

[

Next

Responsive images arrow\_forward](/learn/design/responsive-images)
