...
There are several other types of URLs, such as [blobs](https://developer.mozilla.org/docs/Web/API/Blob#creating_a_url_representing_the_contents_of_a_typed_array) and [data URLs](https://developer.mozilla.org/docs/Web/HTTP/Basics_of_HTTP/Data_URLs) (see examples in the `download` attribute discussion). For secure sites (those served over `https`), it is possible to [create and run app specific protocols](/articles/registering-a-custom-protocol-handler) with [registerProtocolHandler()](https://developer.mozilla.org/docs/Web/API/Navigator/registerProtocolHandler).
...
arrow\_back Text basics](/learn/html/text-basics)

[

Next

Lists arrow\_forward](/learn/html/lists)
