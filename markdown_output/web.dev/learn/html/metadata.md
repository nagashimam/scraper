...
# Metadata Stay organized with collections Save and categorize content based on your preferences.
...
Let's revisit the two necessary `<meta>` tags already covered—the [character set declaration](/learn/html/document-structure#character_encoding) and the [viewport meta tag](/learn/html/document-structure#viewport_metadata)—and get a better understanding of the `<meta>` tag in the process.
...
The most useful pragma directive is `content-security-policy`, which enables defining a [content policy](/articles/csp) for the current document. Content policies mostly specify allowed server origins and script endpoints, which help guard against cross-site scripting attacks.
...
![Facebook card for Machine Learning Workshop.](/static/learn/html/metadata/image/facebook-card-machine-le-645e337e0cb1f.png)
...
![Twitter card for Machine Learning Workshop](/static/learn/html/metadata/image/twitter-card-machine-lea-2c8c7faa580f.png)
...
![A card showing a conference speaker.](/static/learn/html/metadata/image/a-card-showing-conferenc-6db777eca9b62.png)

![The same card with details for a different speaker.](/static/learn/html/metadata/image/the-same-card-details-a-bdd28397f558f.png)
...
arrow\_back Document structure](/learn/html/document-structure)

[

Next

Semantic HTML arrow\_forward](/learn/html/semantic-html)
