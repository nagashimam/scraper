...
# Overview of HTML Stay organized with collections Save and categorize content based on your preferences.
...
![The tags and content that make up an HTML element.](/static/learn/html/overview/image/the-tags-content-make-10a59ba9efd26.png)
...
Output of the above HTML:
 ...
 ![light switch](https://machinelearningworkshop.com/svg/switch2.svg)
...
![An opening tag with attributes.](/static/learn/html/overview/image/an-opening-tag-attribute-363effa33af66.png)
...
Try again. CSS, not HTML is used for styling.

False

Correct! HTML elements are used to describe what the content is.
...
Document structure arrow\_forward](/learn/html/document-structure)
