...
# Text basics Stay organized with collections Save and categorize content based on your preferences.
...
Try again. The `<cite>` element is used to indicate the source of a quote, not the quote itself.

[

Previous

arrow\_back Attributes](/learn/html/attributes)

[

Next

Links arrow\_forward](/learn/html/links)
