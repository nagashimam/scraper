...
As you learned in [Responsive Images](/learn/images/responsive-images), you’ll want to make use of the `<picture>` element to seamlessly handle the WebP or JPEG fallback pattern. In this case, you’ll be using the `type` attribute in concert with `srcset`.
...
![Responsive image report showing size/width mismatch.](/static/learn/images/automating/image/responsive-image-report-s-f8c412f058e06.png)
...
![Responsive image report with suggested dimensions.](/static/learn/images/automating/image/responsive-image-report-6b38c34ba1c81.png)
...
arrow\_back Prescriptive syntaxes](/learn/images/prescriptive)

[

Next

Site Generators, frameworks, and CMSs arrow\_forward](/learn/images/cms)
