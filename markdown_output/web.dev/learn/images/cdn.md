...
# Image content delivery networks Stay organized with collections Save and categorize content based on your preferences.
...
An [image CDN](/articles/image-cdns) can provide all these benefits, with one key difference: the ability to transform and optimize the contents of an image based on strings the URL used to access it.
...
![CDN user interface.](/static/learn/images/cdn/image/cdn-user-interface-7baff89eee95.png)
