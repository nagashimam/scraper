...
# Image formats: JPEG Stay organized with collections Save and categorize content based on your preferences.
...
![Horizontal alignment of green blocks going from light to dark.](/static/learn/images/jpeg/image/horizontal-alignment-gre-aac4d31124765.png)
...
![An eight-by-sixteen grid of green blocks ranging in hue from light to dark.](/static/learn/images/jpeg/image/an-eight-sixteen-grid-g-989417758001c.png)

> Block one is #00CC00. Block two is a gradient from #00CC00 to #005500.

Where JPEG really shines is in quantizing the level of "high frequency" detail in an image, often imperceptibly. As a result, saving an image as a JPEG usually means reducing the quality of that image in ways that are measurable, but not necessarily _visible_. [As you've learned](/learn/images/gif), GIF-style palette quantization is a relatively simple operation: reducing the number of colors in an image results in smaller files, but in a way that can be easy to spot with the human eye.
...
![A highly compressed image of flowers containing many visual artifacts.](/static/learn/images/jpeg/image/a-highly-compressed-image-1bf4caf52860d.png)
...
![Gif showing the superior load speed of a progressive JPEG compared to a regular JPEG.](/learn/images/jpeg/image/jpegs-comparison.gif?w=800)
...
![The Squoosh settings panel, with the quality slider highlighted.](/static/learn/images/jpeg/image/the-squoosh-settings-pane-905218448e9e.png)
...
![The Squoosh settings panel, with the progressive rendering setting highlighted.](/static/learn/images/jpeg/image/the-squoosh-settings-pane-b8d372d26939a.png)
