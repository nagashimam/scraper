...
[Responsive image](/learn/design/responsive-images) markup can be divided into two scenarios: situations where the goal is the most efficient possible images, and situations where you need explicit control over what image source the browser selects. You can think of these as _descriptive_ and _prescriptive_ syntaxes, respectively.
...
To enable browsers to make these choices, `srcset` allows you to provide the browser with a list of potential sources for populating a single `<img>`, while `sizes` allows you to provide the browser with information about how that `<img>` will be rendered. You'll learn how to use these in the [next module](/learn/images/descriptive).
...
In these cases, you want explicit control over which source is shown, and when. These are assurances that `srcset` and `sizes` can't give us, by design. To get that control, we'll need to use the [`<picture>` element](/learn/images/prescriptive).

[

Previous

arrow\_back Image formats: AVIF](/learn/images/avif)

[

Next

Descriptive syntaxes arrow\_forward](/learn/images/descriptive)
