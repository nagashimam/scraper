...
# Why does speed matter? Stay organized with collections Save and categorize content based on your preferences.
...
> 
> [Vodafone](/case-studies/vodafone)
...
At Google, we have spent considerable time and effort defining a set of [user-centric performance metrics](/articles/user-centric-performance-metrics) known as [Core Web Vitals](/articles/vitals). While there are [many Core Web Vitals case studies](/case-studies) on this website highlighting the connection between performance and business outcomes, here are a couple for you to consider:

*   [How The Economic Times passed Core Web Vitals thresholds and achieved an overall 43% better bounce rate](/case-studies/economic-times-cwv)
*   [How Renault improved its bounce and conversion rates by measuring and optimizing Largest Contentful Paint](/case-studies/renault)
...
*   [How Rakuten 24's investment in Core Web Vitals increased revenue per visitor by 53.37% and conversion rate by 33.13%](/case-studies/rakuten)
*   [Vodafone: A 31% improvement in LCP increased sales by 8%](/case-studies/vodafone)
*   [How redBus improved their website's Interaction to Next Paint (INP) and increased sales by 7%](/case-studies/redbus-inp)
...
![A comparison of two filmstrip reels of a page loading. The first shows a page loading on a slow connection, while the second shows the same page loading on a fast connection.](/static/learn/performance/why-speed-matters/image/fig-1.png)
