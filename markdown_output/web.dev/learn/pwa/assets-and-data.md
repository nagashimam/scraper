...
# Assets and data Stay organized with collections Save and categorize content based on your preferences.
...
By default, websites download assets over the network, [starting with HTML](/articles/critical-rendering-path) and continuing to the rest of the resources.
...
Size limits depend on the browser. It's not as flexible as for platform-specific apps, but it's typically good enough for most web apps. You can find the specific limitations by browser in [this article](/articles/storage-for-the-web#how-much).
...
*   [Storage on the Web](/articles/storage-for-the-web)
