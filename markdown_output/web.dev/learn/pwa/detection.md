...
# Detection Stay organized with collections Save and categorize content based on your preferences.
...
![Navigation transfer between a browser tab and a PWA window.](/static/learn/pwa/detection/image/navigation-transfer-betwe-bd1a54572ffc9.png)
...
![Chrome on Android shows menu item to open a new navigation in a PWA window.](/static/learn/pwa/detection/image/chrome-android-shows-men-bc4abd110c859.png)
...
The [`getInstalledRelatedApps()`](/articles/get-installed-related-apps) method allows your website to check whether your iOS/Android/desktop app or PWA is installed on the user's device.
...
From Chrome on Android 89, you can detect if a PWA is installed, even from outside the PWA's scope. Your PWA must set a JSON file within the `/.well-known/` folder, giving permission to the other scope, as described in [this article](/articles/get-installed-related-apps#check-pwa-out-of-scope).

## Resources

*   [Is your app installed? getInstalledRelatedApps() will tell you!](/articles/get-installed-related-apps)
