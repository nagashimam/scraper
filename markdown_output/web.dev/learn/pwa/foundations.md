...
**Note:** Accessibility is key for a successful PWA. Please follow [these guidelines](/articles/pwa-checklist#:~:text=to%20cached%20content%20or%20an%20offline%20indicator%20as%20needed.-,is%20fully%20accessible) to make sure your app is accessible to anyone, anywhere.
...
During the past decade, we've been dealing with different metrics to measure success in web performance. Today, a set of recommended metrics known as [Core Web Vitals](/articles/vitals) focus on three key areas affecting performance and the user experience:

*   Loading—represented by [Largest Contentful Paint (LCP)](/articles/lcp).
*   Interactivity—represented by [Interaction to Next Paint (INP)](/articles/lcp).
*   Visual Stability—represented by [Cumulative Layout Shift (CLS)](/articles/cls).

![A set of metrics from Core Web Vitals showing a website's performance results.](/static/learn/pwa/foundations/image/cwv-assessment.png)
...
*   [The new responsive: Web design in a component-driven world](/articles/new-responsive)
*   [Progressive Enhancement](https://developer.mozilla.org/docs/Glossary/Progressive_Enhancement)
*   [Ten modern layouts in one line of CSS](/articles/one-line-layouts)
*   [Web Vitals](/articles/vitals)
