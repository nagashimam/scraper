...
# Installation prompt Stay organized with collections Save and categorize content based on your preferences.
...
*   The app does not pass the [PWA installation criteria](/learn/pwa/installation#installation_criteria).
...
**Try it:** Try it yourself with the [Make it installable](/articles/codelab-make-installable) codelab.
...
*   [How to provide your own in-app install experience](/articles/customize-install)
