...
# Serving Stay organized with collections Save and categorize content based on your preferences.
...
![The service worker sits between the client and the network.](/static/learn/pwa/serving/image/the-service-worker-sits-b-6649fdd7d05cd.png)
...
Now that you know how to serve HTTP responses from a service worker, it's time to use the [Caching Storage interface](/learn/pwa/caching) to store assets on the device.
...
![The Cache First strategy](/static/learn/pwa/serving/image/the-cache-strategy-9772ea079508c.png)
...
![The Network First strategy](/static/learn/pwa/serving/image/the-network-strategy-cb98325f89daa.png)
...
![The stale while revalidate strategy](/static/learn/pwa/serving/image/the-stale-while-revalidat-4eb9e02cb6f22.png)
...
![The Network only strategy](/static/learn/pwa/serving/image/the-network-strategy-acff1b21e751c.png)
...
![Cache only strategy.](/static/learn/pwa/serving/image/cache-strategy-31f1d2915a6c5.png)
