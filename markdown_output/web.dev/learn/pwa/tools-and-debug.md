...
# Tools and debug Stay organized with collections Save and categorize content based on your preferences.
...
*   Safari Web Inspector: [Responsive Design Mode](https://developer.apple.com/safari/tools/) ![Chromium DevTools simulating mobile devices.](/static/learn/pwa/tools-and-debug/image/chromium-devtools-simulat-4bea8a5fb2ace.png) ![Firefox DevTools simulating mobile devices.](/static/learn/pwa/tools-and-debug/image/firefox-devtools-simulati-49641650c4a71.png) ![Safari Web Inspector Responsive Design mode.](/static/learn/pwa/tools-and-debug/image/safari-web-inspector-resp-53111c832e67f.png) Some commercial and free solutions are optimized for developers and designers, such as the open source [Responsively app](https://responsively.app).
...
![Simulator with Safari rendering websites on iPhones and iPad.](/static/learn/pwa/tools-and-debug/image/simulator-safari-renderi-2c1da71dc324d.png)
...
![The AVD manager with an Android Virtual device browsing a website](/static/learn/pwa/tools-and-debug/image/the-avd-manager-an-andro-bb03c5914ec67.png)
...
![Creating AVDs with an operating system including Play services.](/static/learn/pwa/tools-and-debug/image/creating-avds-an-operati-02cc8e7fceb53.png)
...
![Android emulator installing Microsoft Edge from Play store.](/static/learn/pwa/tools-and-debug/image/android-emulator-installi-91dfd37493dff.png)
...
![Remote Test Lab from Samsung with a foldable phone.](/static/learn/pwa/tools-and-debug/image/remote-test-lab-samsung-c7dba482d59e4.png)
...
![Service Worker debugging tools con Chromium DevTools.](/static/learn/pwa/tools-and-debug/image/service-worker-debugging-673821a5cd2b.png)
...
![Cache Inspector in Chromium DevTools](/static/learn/pwa/tools-and-debug/image/cache-inspector-chromium-7f17d02f39b76.png)
...
Chromium DevTools has a section for Web App Manifest and installability criteria under `Application`, `Manifest`. In this section, you can check whether the manifest has loaded correctly, the manifest's values, how the icons look, the [app id](/learn/pwa/web-app-manifest#basic_fields), and a quick checker for [maskable icons](/learn/pwa/web-app-manifest#maskable_icons).

Warnings and errors around [installability criteria](/learn/pwa/installation#installation_criteria) issues are also shown in this section.

![Debugging Web App Manifest in Chromium DevTools.](/static/learn/pwa/tools-and-debug/image/debugging-web-app-manifes-884c6b833585b.png)
...
![Google Chrome WebAPK debug screen on Android.](/static/learn/pwa/tools-and-debug/image/google-chrome-webapk-debu-b08db51a06ce6.png)
...
![A Service Worker Web Inspector from a PWA in Safari.](/static/learn/pwa/tools-and-debug/image/a-service-worker-web-insp-d9eafd07b9da4.png)
...
![Firefox Developer Tools for Service Worker and Manifest.](/static/learn/pwa/tools-and-debug/image/firefox-developer-tools-2ac0fefa74a38.png)
