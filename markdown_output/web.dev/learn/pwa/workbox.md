...
# Workbox Stay organized with collections Save and categorize content based on your preferences.
...
![Workbox CLI in action in a terminal](/static/learn/pwa/workbox/image/workbox-cli-action-a-te-cdda129657c2f.png)
...
The module [_workbox-strategies_](https://developer.chrome.com/docs/workbox/modules/workbox-strategies) provides, out of the box, the caching strategies discussed in the [Assets and data](/learn/pwa/assets-and-data) and [Serving](/learn/pwa/serving) chapters.
